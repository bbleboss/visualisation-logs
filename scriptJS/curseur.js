...
function affiche(){ //affichage du curseur
        ...
        if(currentLocation == "error.php" || currentLocation == "requete.php" || currentLocation == "agent.php" || currentLocation == "serveur.php" || currentLocation == "statut.php" || currentLocation == "typerequete.php")
        {
