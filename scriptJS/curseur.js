...
function affiche(){ //affichage du curseur
		...
		else if(currentLocation == "typerequete.php")
		{
			...
			//document.getElementById('curseur').innerHTML =document.getElementById('curseur').innerHTML + "<label for =\"selection\"> Selectionner</label> :<select name=\"selection\" id=\"selection\"> <option value=\"all\" onclick=\"update()\">Tout</option><option value=\"get\" onclick=\"update()\">GET</option></select><br/>"
			if(typerequest == "tout")
			{	
			 	document.getElementById('curseur').innerHTML =document.getElementById('curseur').innerHTML + "<input type=\"radio\" id=\"tout\" name=\"typerequete\" onclick=\"update()\" checked>Tout  <input type=\"radio\" id=\"get\" name=\"typerequete\" onclick=\"update()\">GET <input type=\"radio\" id=\"post\" name=\"typerequete\" onclick=\"update()\">POST <input type=\"radio\" id=\"options\" name=\"typerequete\" onclick=\"update()\">OPTIONS <input type=\"radio\" id=\"head\" name=\"typerequete\" onclick=\"update()\">HEAD <input type=\"radio\" id=\"put\" name=\"typerequete\" onclick=\"update()\">PUT  <input type=\"radio\" id=\"delete\" name=\"typerequete\" onclick=\"update()\">DELETE <input type=\"radio\" id=\"connect\" name=\"typerequete\" onclick=\"update()\">CONNECT <input type=\"radio\" id=\"trace\" name=\"typerequete\" onclick=\"update()\">TRACE <input type=\"radio\" id=\"patch\" name=\"typerequete\" onclick=\"update()\">PATCH </br><button id=\"updateForm\">Mettre à jour le formulaire</button>Période du <input id= curDate1 name=cursDate1 type=text readonly/> au <input id= curDate2 name=cursDate2 type=text readonly/>";
			}
			else if(typerequest == "get")
			{	
			 	document.getElementById('curseur').innerHTML =document.getElementById('curseur').innerHTML + "<input type=\"radio\" id=\"tout\" name=\"typerequete\" onclick=\"update()\">Tout  <input type=\"radio\" id=\"get\" name=\"typerequete\" onclick=\"update()\"checked>GET <input type=\"radio\" id=\"post\" name=\"typerequete\" onclick=\"update()\">POST <input type=\"radio\" id=\"options\" name=\"typerequete\" onclick=\"update()\">OPTIONS <input type=\"radio\" id=\"head\" name=\"typerequete\" onclick=\"update()\">HEAD <input type=\"radio\" id=\"put\" name=\"typerequete\" onclick=\"update()\">PUT  <input type=\"radio\" id=\"delete\" name=\"typerequete\" onclick=\"update()\">DELETE <input type=\"radio\" id=\"connect\" name=\"typerequete\" onclick=\"update()\">CONNECT <input type=\"radio\" id=\"trace\" name=\"typerequete\" onclick=\"update()\">TRACE <input type=\"radio\" id=\"patch\" name=\"typerequete\" onclick=\"update()\">PATCH </br><button id=\"updateForm\">Mettre à jour le formulaire</button>Période du <input id= curDate1 name=cursDate1 type=text readonly/> au <input id= curDate2 name=cursDate2 type=text readonly/>";
			}
			else if(typerequest == "post")
			{
			 	document.getElementById('curseur').innerHTML =document.getElementById('curseur').innerHTML + "<input type=\"radio\" id=\"tout\" name=\"typerequete\" onclick=\"update()\">Tout  <input type=\"radio\" id=\"get\" name=\"typerequete\" onclick=\"update()\">GET <input type=\"radio\" id=\"post\" name=\"typerequete\" onclick=\"update()\"checked>POST <input type=\"radio\" id=\"options\" name=\"typerequete\" onclick=\"update()\">OPTIONS <input type=\"radio\" id=\"head\" name=\"typerequete\" onclick=\"update()\">HEAD <input type=\"radio\" id=\"put\" name=\"typerequete\" onclick=\"update()\">PUT  <input type=\"radio\" id=\"delete\" name=\"typerequete\" onclick=\"update()\">DELETE <input type=\"radio\" id=\"connect\" name=\"typerequete\" onclick=\"update()\">CONNECT <input type=\"radio\" id=\"trace\" name=\"typerequete\" onclick=\"update()\">TRACE <input type=\"radio\" id=\"patch\" name=\"typerequete\" onclick=\"update()\">PATCH </br><button id=\"updateForm\">Mettre à jour le formulaire</button>Période du <input id= curDate1 name=cursDate1 type=text readonly/> au <input id= curDate2 name=cursDate2 type=text readonly/>";
			}
			else if(typerequest == "options")
			{
			 	document.getElementById('curseur').innerHTML =document.getElementById('curseur').innerHTML + "<input type=\"radio\" id=\"tout\" name=\"typerequete\" onclick=\"update()\">Tout  <input type=\"radio\" id=\"get\" name=\"typerequete\" onclick=\"update()\">GET <input type=\"radio\" id=\"post\" name=\"typerequete\" onclick=\"update()\">POST <input type=\"radio\" id=\"options\" name=\"typerequete\" onclick=\"update()\"checked>OPTIONS <input type=\"radio\" id=\"head\" name=\"typerequete\" onclick=\"update()\">HEAD <input type=\"radio\" id=\"put\" name=\"typerequete\" onclick=\"update()\">PUT  <input type=\"radio\" id=\"delete\" name=\"typerequete\" onclick=\"update()\">DELETE <input type=\"radio\" id=\"connect\" name=\"typerequete\" onclick=\"update()\">CONNECT <input type=\"radio\" id=\"trace\" name=\"typerequete\" onclick=\"update()\">TRACE <input type=\"radio\" id=\"patch\" name=\"typerequete\" onclick=\"update()\">PATCH </br><button id=\"updateForm\">Mettre à jour le formulaire</button>Période du <input id= curDate1 name=cursDate1 type=text readonly/> au <input id= curDate2 name=cursDate2 type=text readonly/>";
			}
			else if(typerequest == "head")
			{
			 	document.getElementById('curseur').innerHTML =document.getElementById('curseur').innerHTML + "<input type=\"radio\" id=\"tout\" name=\"typerequete\" onclick=\"update()\">Tout  <input type=\"radio\" id=\"get\" name=\"typerequete\" onclick=\"update()\">GET <input type=\"radio\" id=\"post\" name=\"typerequete\" onclick=\"update()\">POST <input type=\"radio\" id=\"options\" name=\"typerequete\" onclick=\"update()\">OPTIONS <input type=\"radio\" id=\"head\" name=\"typerequete\" onclick=\"update()\"checked>HEAD <input type=\"radio\" id=\"put\" name=\"typerequete\" onclick=\"update()\">PUT  <input type=\"radio\" id=\"delete\" name=\"typerequete\" onclick=\"update()\">DELETE <input type=\"radio\" id=\"connect\" name=\"typerequete\" onclick=\"update()\">CONNECT <input type=\"radio\" id=\"trace\" name=\"typerequete\" onclick=\"update()\">TRACE <input type=\"radio\" id=\"patch\" name=\"typerequete\" onclick=\"update()\">PATCH </br><button id=\"updateForm\">Mettre à jour le formulaire</button>Période du <input id= curDate1 name=cursDate1 type=text readonly/> au <input id= curDate2 name=cursDate2 type=text readonly/>";
			}
			else if(typerequest == "put")
			{
			 	document.getElementById('curseur').innerHTML =document.getElementById('curseur').innerHTML + "<input type=\"radio\" id=\"tout\" name=\"typerequete\" onclick=\"update()\">Tout  <input type=\"radio\" id=\"get\" name=\"typerequete\" onclick=\"update()\">GET <input type=\"radio\" id=\"post\" name=\"typerequete\" onclick=\"update()\">POST <input type=\"radio\" id=\"options\" name=\"typerequete\" onclick=\"update()\">OPTIONS <input type=\"radio\" id=\"head\" name=\"typerequete\" onclick=\"update()\">HEAD <input type=\"radio\" id=\"put\" name=\"typerequete\" onclick=\"update()\"checked>PUT  <input type=\"radio\" id=\"delete\" name=\"typerequete\" onclick=\"update()\">DELETE <input type=\"radio\" id=\"connect\" name=\"typerequete\" onclick=\"update()\">CONNECT <input type=\"radio\" id=\"trace\" name=\"typerequete\" onclick=\"update()\">TRACE <input type=\"radio\" id=\"patch\" name=\"typerequete\" onclick=\"update()\">PATCH </br><button id=\"updateForm\">Mettre à jour le formulaire</button>Période du <input id= curDate1 name=cursDate1 type=text readonly/> au <input id= curDate2 name=cursDate2 type=text readonly/>";
			}
			else if(typerequest == "delete")
			{
			 	document.getElementById('curseur').innerHTML =document.getElementById('curseur').innerHTML + "<input type=\"radio\" id=\"tout\" name=\"typerequete\" onclick=\"update()\">Tout  <input type=\"radio\" id=\"get\" name=\"typerequete\" onclick=\"update()\">GET <input type=\"radio\" id=\"post\" name=\"typerequete\" onclick=\"update()\">POST <input type=\"radio\" id=\"options\" name=\"typerequete\" onclick=\"update()\">OPTIONS <input type=\"radio\" id=\"head\" name=\"typerequete\" onclick=\"update()\">HEAD <input type=\"radio\" id=\"put\" name=\"typerequete\" onclick=\"update()\">PUT  <input type=\"radio\" id=\"delete\" name=\"typerequete\" onclick=\"update()\"checked>DELETE <input type=\"radio\" id=\"connect\" name=\"typerequete\" onclick=\"update()\">CONNECT <input type=\"radio\" id=\"trace\" name=\"typerequete\" onclick=\"update()\">TRACE <input type=\"radio\" id=\"patch\" name=\"typerequete\" onclick=\"update()\">PATCH </br><button id=\"updateForm\">Mettre à jour le formulaire</button>Période du <input id= curDate1 name=cursDate1 type=text readonly/> au <input id= curDate2 name=cursDate2 type=text readonly/>";
			}
			else if(typerequest == "connect")
			{
			 	document.getElementById('curseur').innerHTML =document.getElementById('curseur').innerHTML + "<input type=\"radio\" id=\"tout\" name=\"typerequete\" onclick=\"update()\">Tout  <input type=\"radio\" id=\"get\" name=\"typerequete\" onclick=\"update()\">GET <input type=\"radio\" id=\"post\" name=\"typerequete\" onclick=\"update()\">POST <input type=\"radio\" id=\"options\" name=\"typerequete\" onclick=\"update()\">OPTIONS <input type=\"radio\" id=\"head\" name=\"typerequete\" onclick=\"update()\">HEAD <input type=\"radio\" id=\"put\" name=\"typerequete\" onclick=\"update()\">PUT  <input type=\"radio\" id=\"delete\" name=\"typerequete\" onclick=\"update()\">DELETE <input type=\"radio\" id=\"connect\" name=\"typerequete\" onclick=\"update()\"checked>CONNECT <input type=\"radio\" id=\"trace\" name=\"typerequete\" onclick=\"update()\">TRACE <input type=\"radio\" id=\"patch\" name=\"typerequete\" onclick=\"update()\">PATCH </br><button id=\"updateForm\">Mettre à jour le formulaire</button>Période du <input id= curDate1 name=cursDate1 type=text readonly/> au <input id= curDate2 name=cursDate2 type=text readonly/>";
			}
			else if(typerequest == "trace")
			{
			 	document.getElementById('curseur').innerHTML =document.getElementById('curseur').innerHTML + "<input type=\"radio\" id=\"tout\" name=\"typerequete\" onclick=\"update()\">Tout  <input type=\"radio\" id=\"get\" name=\"typerequete\" onclick=\"update()\">GET <input type=\"radio\" id=\"post\" name=\"typerequete\" onclick=\"update()\">POST <input type=\"radio\" id=\"options\" name=\"typerequete\" onclick=\"update()\">OPTIONS <input type=\"radio\" id=\"head\" name=\"typerequete\" onclick=\"update()\">HEAD <input type=\"radio\" id=\"put\" name=\"typerequete\" onclick=\"update()\">PUT  <input type=\"radio\" id=\"delete\" name=\"typerequete\" onclick=\"update()\">DELETE <input type=\"radio\" id=\"connect\" name=\"typerequete\" onclick=\"update()\">CONNECT <input type=\"radio\" id=\"trace\" name=\"typerequete\" onclick=\"update()\"checked>TRACE <input type=\"radio\" id=\"patch\" name=\"typerequete\" onclick=\"update()\">PATCH </br><button id=\"updateForm\">Mettre à jour le formulaire</button>Période du <input id= curDate1 name=cursDate1 type=text readonly/> au <input id= curDate2 name=cursDate2 type=text readonly/>";
			}
			else if(typerequest == "patch")
			{
			 	document.getElementById('curseur').innerHTML =document.getElementById('curseur').innerHTML + "<input type=\"radio\" id=\"tout\" name=\"typerequete\" onclick=\"update()\">Tout  <input type=\"radio\" id=\"get\" name=\"typerequete\" onclick=\"update()\">GET <input type=\"radio\" id=\"post\" name=\"typerequete\" onclick=\"update()\">POST <input type=\"radio\" id=\"options\" name=\"typerequete\" onclick=\"update()\">OPTIONS <input type=\"radio\" id=\"head\" name=\"typerequete\" onclick=\"update()\">HEAD <input type=\"radio\" id=\"put\" name=\"typerequete\" onclick=\"update()\">PUT  <input type=\"radio\" id=\"delete\" name=\"typerequete\" onclick=\"update()\">DELETE <input type=\"radio\" id=\"connect\" name=\"typerequete\" onclick=\"update()\">CONNECT <input type=\"radio\" id=\"trace\" name=\"typerequete\" onclick=\"update()\">TRACE <input type=\"radio\" id=\"patch\" name=\"typerequete\" onclick=\"update()\"checked>PATCH </br><button id=\"updateForm\">Mettre à jour le formulaire</button>Période du <input id= curDate1 name=cursDate1 type=text readonly/> au <input id= curDate2 name=cursDate2 type=text readonly/>";
			}
		}
